...
1. Створити файл конфігурації `.env.local` в корені проєкту з наступним вмістом (або перейменувати файл `.env.example` в `.env.local` та заповнити відповідні параметри):
